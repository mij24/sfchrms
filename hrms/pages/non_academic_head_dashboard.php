<?php
// FILE: pages/non_academic_head_dashboard.php — Dashboard for Non-Academic Head
...
if (!(isset($_SESSION['role']) && $_SESSION['role']==='non_academic_head')) {
...
$dept_emp_count=0;
try {
    $dept_id=(int)db_value($pdo,"SELECT department_id FROM employees WHERE id=?",array($my_emp_id));
    if($dept_id) $dept_emp_count=(int)db_value($pdo,"SELECT COUNT(*) FROM employees WHERE department_id=? AND employment_status='Active'",array($dept_id));
} catch(Exception $e){}
$pending_dept_req=0;
try {
    if(isset($dept_id) ? $dept_id : 0) $pending_dept_req=(int)db_value($pdo,"SELECT COUNT(*) FROM employee_requests er JOIN employees e ON er.employee_id=e.id WHERE e.department_id=? AND er.status IN ('Pending','In Progress')",array($dept_id));
} catch(Exception $e){}
...
<head>
  ...
  <title><?= htmlspecialchars('Non-Academic Head') ?> Dashboard | HRMS</title>
  <link rel="stylesheet" href="../assets/plugins/fontawesome-free/css/all.min.css">
  <link rel="stylesheet" href="../assets/dist/css/adminlte.min.css">
  <link rel="stylesheet" href="../assets/dist/css/custom.css">
  <style>
    .dash-banner {
      background: linear-gradient(135deg, #20c997dd, #20c99788);
...
<div class="content-wrapper">
  <div class="content-header"><div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0"><i class="fas fa-briefcase mr-2" style="color:#20c997;"></i>Non-Academic Head Dashboard</h1>
      </div>
      <div class="col-sm-6">
  ...
  <div class="content"><div class="container-fluid">
    ...
    <div class="dash-banner">
      <div class="row align-items-center">
        ...
        <div class="col-auto text-right">
          ...
          <div class="role-label">Non-Academic Department Head</div>
        </div>
      </div>
    </div>
      ...
      <div class="col-6 col-md-3 mb-3">
        <div class="info-box shadow-sm">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Dept Employees</span>
            <span class="info-box-number"><?= $dept_emp_count ?></span>
          </div>
        </div>
      </div>
      <div class="col-6 col-md-3 mb-3">
        <div class="info-box shadow-sm">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Dept Pending Requests</span>
            <span class="info-box-number"><?= $pending_dept_req ?></span>
          </div>
        </div>
      </div>
      <div class="col-6 col-md-3 mb-3">
        <div class="info-box shadow-sm">
          ...
          <div class="info-box-content">
            <span class="info-box-text">My Pending Requests</span>
            <span class="info-box-number"><?= $pending_req ?></span>
          </div>
        </div>
      </div>
      <div class="col-6 col-md-3 mb-3">
        <div class="info-box shadow-sm">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Inbox Items</span>
    ...
    <div class="row">
      <!-- Quick Access -->
      <div class="col-md-8">
        <div class="card card-outline" style="border-top:3px solid #20c997;">
          <div class="card-header">
            <h3 class="card-title"><i class="fas fa-bolt mr-2" style="color:#20c997;"></i>Quick Access</h3>
          </div>
          <div class="card-body">
            <div class="row">
            ...
            <div class="col-6 col-sm-4 col-md-3 mb-3">
              <a href="attendance_log.php" class="btn btn-outline-info btn-block py-3">
                <i class="fas fa-clock fa-lg d-block mb-1"></i>
                <span style="font-size:12px;">Attendance Log</span>
              </a>
            </div>
            <div class="col-6 col-sm-4 col-md-3 mb-3">
              <a href="reports.php" class="btn btn-outline-primary btn-block py-3">
      ...
      <div class="col-md-4">
        <div class="card card-outline" style="border-top:3px solid #20c997;">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title"><i class="fas fa-bullhorn mr-2" style="color:#20c997;"></i>Announcements</h3>
          </div>
