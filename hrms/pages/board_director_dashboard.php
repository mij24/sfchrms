<?php
// FILE: pages/board_director_dashboard.php — Dashboard for Board of Directors
...
if (!(isset($_SESSION['role']) && $_SESSION['role']==='board_director')) {
...
<head>
  ...
  <title><?= htmlspecialchars('Board of Directors') ?> Dashboard | HRMS</title>
...
<div class="content-wrapper">
  <div class="content-header"><div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0"><i class="fas fa-landmark mr-2" style="color:#343a40;"></i>Board of Directors Dashboard</h1>
      </div>
      <div class="col-sm-6">
    ...
    <div class="dash-banner">
      <div class="row align-items-center">
        ...
        <div class="col-auto text-right">
          ...
          <div class="role-label">Board of Directors Member</div>
        </div>
      </div>
    </div>
      ...
      <div class="col-6 col-md-3 mb-3">
        <div class="info-box shadow-sm">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?= $total_dept ?></span>
          </div>
        </div>
      </div>
      <div class="col-6 col-md-3 mb-3">
      ...
      <div class="col-md-8">
        <div class="card card-outline" style="border-top:3px solid #343a40;">
          ...
          <div class="card-body">
            ...
            <div class="col-6 col-sm-4 col-md-3 mb-3">
              <a href="org_chart.php" class="btn btn-outline-info btn-block py-3">
                <i class="fas fa-sitemap fa-lg d-block mb-1"></i>
                <span style="font-size:12px;">Org Chart</span>
              </a>
            </div>
            <div class="col-6 col-sm-4 col-md-3 mb-3">
