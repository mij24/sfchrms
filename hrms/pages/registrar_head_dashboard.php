<?php
// FILE: pages/registrar_head_dashboard.php — Dashboard for Head Registrar
...
if (!(isset($_SESSION['role']) && $_SESSION['role']==='registrar_head')) {
...
$tl_for_verify=0;
try {
    $tl_for_verify=(int)db_value($pdo,"SELECT COUNT(*) FROM teaching_loads WHERE status='For Registrar Verification'");
} catch(Exception $e){}
...
<head>
  ...
  <title><?= htmlspecialchars('Head Registrar') ?> Dashboard | HRMS</title>
  <link rel="stylesheet" href="../assets/plugins/fontawesome-free/css/all.min.css">
  <link rel="stylesheet" href="../assets/dist/css/adminlte.min.css">
  <link rel="stylesheet" href="../assets/dist/css/custom.css">
  <style>
    .dash-banner {
      background: linear-gradient(135deg, #ffc107dd, #ffc10788);
...
<div class="content-wrapper">
  <div class="content-header"><div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0"><i class="fas fa-stamp mr-2" style="color:#ffc107;"></i>Head Registrar Dashboard</h1>
      </div>
      <div class="col-sm-6">
  ...
  <div class="content"><div class="container-fluid">
    ...
    <div class="dash-banner">
      <div class="row align-items-center">
        ...
        <div class="col-auto text-right">
          ...
          <div class="role-label">Head Registrar</div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-6 col-md-3 mb-3">
        <div class="info-box shadow-sm">
          <span class="info-box-icon bg-warning"><i class="fas fa-stamp"></i></span>
          <div class="info-box-content">
            <span class="info-box-text">TL for Verification</span>
            <span class="info-box-number"><?= $tl_for_verify ?></span>
          </div>
        </div>
      </div>
      <div class="col-6 col-md-3 mb-3">
      ...
      <div class="col-6 col-md-3 mb-3">
        <div class="info-box shadow-sm">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Approved (This Year)</span>
            <span class="info-box-number"><?= $approved_req ?></span>
          </div>
        </div>
      </div>
      <div class="col-6 col-md-3 mb-3">
    ...
    <div class="row">
      <!-- Quick Access -->
      <div class="col-md-8">
        <div class="card card-outline" style="border-top:3px solid #ffc107;">
          <div class="card-header">
            <h3 class="card-title"><i class="fas fa-bolt mr-2" style="color:#ffc107;"></i>Quick Access</h3>
          </div>
          <div class="card-body">
            <div class="row">
            ...
            <div class="col-6 col-sm-4 col-md-3 mb-3">
              <a href="my_requests.php" class="btn btn-outline-primary btn-block py-3">
                <i class="fas fa-file-alt fa-lg d-block mb-1"></i>
                <span style="font-size:12px;">File Request</span>
              </a>
            </div>
            </div>
          </div>
      ...
      <div class="col-md-4">
        <div class="card card-outline" style="border-top:3px solid #ffc107;">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title"><i class="fas fa-bullhorn mr-2" style="color:#ffc107;"></i>Announcements</h3>
          </div>
