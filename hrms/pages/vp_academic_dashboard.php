<?php
// FILE: pages/vp_academic_dashboard.php — Dashboard for VP for Academic Affairs
...
if (!(isset($_SESSION['role']) && $_SESSION['role']==='vp_academic')) {
...
$tl_for_vp=0; $pending_approvals=0; $tl_approved=0;
try {
    $tl_for_vp=(int)db_value($pdo,"SELECT COUNT(*) FROM teaching_loads WHERE status='For VP Academic Review'");
    $tl_approved=(int)db_value($pdo,"SELECT COUNT(*) FROM teaching_loads WHERE status='Approved' AND YEAR(created_at)=YEAR(CURDATE())");
    $pending_approvals=(int)db_value($pdo,"SELECT COUNT(*) FROM employee_requests WHERE status IN ('Pending','In Progress')");
} catch(Exception $e){}
...
<head>
  ...
  <title><?= htmlspecialchars('VP for Academic Affairs') ?> Dashboard | HRMS</title>
  <link rel="stylesheet" href="../assets/plugins/fontawesome-free/css/all.min.css">
  <link rel="stylesheet" href="../assets/dist/css/adminlte.min.css">
  <link rel="stylesheet" href="../assets/dist/css/custom.css">
  <style>
    .dash-banner {
      background: linear-gradient(135deg, #007bffdd, #007bff88);
...
<div class="content-wrapper">
  <div class="content-header"><div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0"><i class="fas fa-university mr-2" style="color:#007bff;"></i>VP for Academic Affairs Dashboard</h1>
      </div>
      <div class="col-sm-6">
  ...
  <div class="content"><div class="container-fluid">
    ...
    <div class="dash-banner">
      <div class="row align-items-center">
        ...
        <div class="col-auto text-right">
          ...
          <div class="role-label">Vice President for Academic Affairs</div>
        </div>
      </div>
    </div>
      ...
      <div class="col-6 col-md-3 mb-3">
        <div class="info-box shadow-sm">
          ...
          <div class="info-box-content">
            <span class="info-box-text">TL Awaiting Review</span>
            <span class="info-box-number"><?= $tl_for_vp ?></span>
          </div>
        </div>
      </div>
      <div class="col-6 col-md-3 mb-3">
        <div class="info-box shadow-sm">
          ...
          <div class="info-box-content">
            <span class="info-box-text">TL Approved (Year)</span>
            <span class="info-box-number"><?= $tl_approved ?></span>
          </div>
        </div>
      </div>
      <div class="col-6 col-md-3 mb-3">
        <div class="info-box shadow-sm">
          ...
          <div class="info-box-content">
            <span class="info-box-text">System-wide Pending</span>
            <span class="info-box-number"><?= $pending_approvals ?></span>
          </div>
        </div>
      </div>
      <div class="col-6 col-md-3 mb-3">
    ...
    <div class="row">
      <!-- Quick Access -->
      <div class="col-md-8">
        <div class="card card-outline" style="border-top:3px solid #007bff;">
          <div class="card-header">
            <h3 class="card-title"><i class="fas fa-bolt mr-2" style="color:#007bff;"></i>Quick Access</h3>
          </div>
          <div class="card-body">
            <div class="row">

            <div class="col-6 col-sm-4 col-md-3 mb-3">
              <a href="teaching_load.php" class="btn btn-outline-primary btn-block py-3">
      ...
      <div class="col-md-4">
        <div class="card card-outline" style="border-top:3px solid #007bff;">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title"><i class="fas fa-bullhorn mr-2" style="color:#007bff;"></i>Announcements</h3>
          </div>
