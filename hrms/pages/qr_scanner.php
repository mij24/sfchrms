...
if (isset($_GET['token']) && !empty($_GET['token'])) {
    ...
    if (!$qr) {
        ...
        if (!$qr['att_id']) {
            ...
            $message      = $status === 'Late'
                ? "Good ".date('A', time()+$_hrms_delta).", {$qr['full_name']}! You are late by $tardy minute(s)."
                : "Good ".date('A', time()+$_hrms_delta).", {$qr['full_name']}! Time-in recorded at ".date('h:i A', time()+$_hrms_delta).".";
            ...
            $message = "Goodbye, {$qr['full_name']}! Time-out at ".date('h:i A', time()+$_hrms_delta).".";
...
<div class="header">
  ...
  <div class="clock" id="clock"><?= date('h:i:s A', time()+$_hrms_delta) ?></div>
  <div class="date"><?= date('l, F d, Y', time()+$_hrms_delta) ?></div>
</div>
