<?php
// FILE: pages/clinic_staff_dashboard.php — Dashboard for Clinic Staff
...
if (!(isset($_SESSION['role']) && $_SESSION['role']==='clinic_staff')) {
...
<head>
  ...
  <title><?= htmlspecialchars('Clinic Staff') ?> Dashboard | HRMS</title>
...
<div class="content-wrapper">
  <div class="content-header"><div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0"><i class="fas fa-stethoscope mr-2" style="color:#28a745;"></i>Clinic Staff Dashboard</h1>
      </div>
      <div class="col-sm-6">
    ...
    <div class="dash-banner">
      <div class="row align-items-center">
        ...
        <div class="col-auto text-right">
          ...
          <div class="role-label">Clinic Staff</div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-6 col-md-3 mb-3">
        <div class="info-box shadow-sm">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Returned/Rejected</span>
            <span class="info-box-number"><?= $rejected_req ?></span>
          </div>
        </div>
      </div>
      <div class="col-6 col-md-3 mb-3">
