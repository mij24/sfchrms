<?php
// FILE: pages/clinic_head_dashboard.php — Dashboard for Clinic Head
...
if (!(isset($_SESSION['role']) && $_SESSION['role']==='clinic_head')) {
...
$sick_pending=0;
try {
    $sick_pending=(int)db_value($pdo,"SELECT COUNT(*) FROM employee_requests er JOIN request_types rt ON er.request_type_id=rt.id WHERE rt.name LIKE '%Sick%' AND er.status IN ('Pending','In Progress')");
} catch(Exception $e){}
...
<head>
  ...
  <title><?= htmlspecialchars('Clinic Head') ?> Dashboard | HRMS</title>
  <link rel="stylesheet" href="../assets/plugins/fontawesome-free/css/all.min.css">
  <link rel="stylesheet" href="../assets/dist/css/adminlte.min.css">
  <link rel="stylesheet" href="../assets/dist/css/custom.css">
  <style>
    .dash-banner {
      background: linear-gradient(135deg, #28a745dd, #28a74588);
...
<div class="content-wrapper">
  <div class="content-header"><div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0"><i class="fas fa-heartbeat mr-2" style="color:#28a745;"></i>Clinic Head Dashboard</h1>
      </div>
      <div class="col-sm-6">
    ...
    <div class="dash-banner">
      <div class="row align-items-center">
        ...
        <div class="col-auto text-right">
          ...
          <div class="role-label">Clinic Head</div>
        </div>
      </div>
    </div>
      ...
      <div class="col-6 col-md-3 mb-3">
        <div class="info-box shadow-sm">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Sick Leave Pending</span>
            <span class="info-box-number"><?= $sick_pending ?></span>
          </div>
        </div>
      </div>
      <div class="col-6 col-md-3 mb-3">
      ...
      <div class="col-md-8">
        <div class="card card-outline" style="border-top:3px solid #28a745;">
          <div class="card-header">
            <h3 class="card-title"><i class="fas fa-bolt mr-2" style="color:#28a745;"></i>Quick Access</h3>
          </div>
          <div class="card-body">
            <div class="row">
            ...
            <div class="col-6 col-sm-4 col-md-3 mb-3">
              <a href="employee_requests.php" class="btn btn-outline-warning btn-block py-3">
                ...
                <span style="font-size:12px;">Sick Leave Requests</span>
              </a>
            </div>
            <div class="col-6 col-sm-4 col-md-3 mb-3">
      ...
      <div class="col-md-4">
        <div class="card card-outline" style="border-top:3px solid #28a745;">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title"><i class="fas fa-bullhorn mr-2" style="color:#28a745;"></i>Announcements</h3>
          </div>
