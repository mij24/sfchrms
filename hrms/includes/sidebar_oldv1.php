  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent"
        ...
        <li class="nav-item">
          <a href="my_attendance.php" class="nav-link <?= sa(array('my_attendance.php','attendance_selfservice.php')) ?>">
            <i class="far fa-circle nav-icon"></i><p>My Attendance</p>
          </a>
        </li>

        <!-- ── My Requests (self-service) ── -->
        <li class="nav-item">
          <a href="my_requests.php" class="nav-link <?= sa(array('my_requests.php','my_requests_history.php','my_requests_tracking.php')) ?>">
            <i class="far fa-circle nav-icon"></i><p>My Requests</p>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a href="hr_setup.php" class="nav-link <?= sa(array('hr_setup.php','employee_id_generator.php','leave_types.php')) ?>">
            <i class="nav-icon fas fa-sliders-h"></i><p>HR Setup</p>
          </a>
        </li>
        <?php endif; ?>
        ...
        <li class="nav-item <?= so(array('settings.php')) ?>">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="settings.php?tab=company" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Company Info</p></a>
            </li>
            <li class="nav-item">
              <a href="settings.php?tab=payroll" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Payroll Config</p></a>
            </li>
            <li class="nav-item">
              <a href="settings.php?tab=time" class="nav-link">
                <i class="fas fa-clock nav-icon" style="color:#ffc107;"></i>
                <p>System Clock <span style="background:#ffc107;color:#000;font-size:9px;padding:1px 5px;border-radius:3px;margin-left:3px;">DTR</span></p>
              </a>
            </li>
            <li class="nav-item">
